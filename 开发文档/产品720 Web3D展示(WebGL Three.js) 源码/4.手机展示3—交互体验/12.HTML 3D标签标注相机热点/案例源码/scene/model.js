...
// 通过CSS3DObject把HTML元素包装为一个类似网格模型Mesh的three.js模型对象
import { CSS3DObject } from '../../../../three.js-r125/examples/jsm/renderers/CSS3DRenderer.js';
...
loader.load("./scene/model/手机.glb", function (gltf) {//gltf加载成功后返回一个对象
    ...
    // label默认大小数量级大约是HTML元素的宽高像素尺寸
    label.scale.set(0.22,0.22,1.0);//根据相机渲染范围缩放到合适尺寸
    label.position.x+= -504*0.22/2;//默认尺寸504 缩放0.22倍  平移504*0.22的一半
